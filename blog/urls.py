...
urlpatterns = [
    ...
    path('downloadvideo',views.downloadvideo, name="download" ),
    path('downloadvideourl/<int:pk>/',views.downloadvideourl, name="downloadvideourl" ),
    path('downloadaudiourl/<int:pk>/',views.downloadaudiourl, name="downloadaudiourl" ),
    path('api_download', views.api_download, name='api_download'),
    # path("feed/randompost", RandomPost(), name="random_post_feed"),
